...
n = Lane:new("N", 100, L1)
-- Signalgruppen fuer N werden nach der Kreuzung angelegt
...
local sgLaneNorthRight = k1:newSignalGroup("sgLaneNorthRight"):addVehicleSignals(K8)
...
phase2:addSignalGroup(sgLaneWest2, sgLaneNorthRight, sgPedEast)
