...
Prüfe deshalb zusätzlich, ob diese Verzeichnisse vorhanden sind, und lösche sie bei Bedarf:
...
2. `LUA\ce` löschen.
3. `Resourcen\Anlagen\ce` löschen, falls vorhanden.
4. Alte Demo-Anlagen unter `Resourcen\Anlagen\Andreas_Kreuz-*` löschen, falls sie aus früheren Installationen stammen.
5. Danach die neue Installationsdatei ausführen.
