...
local fieldGetters = {
    ...
    axisNames = function (s) return copyTable(s:getAxisNames()) end,
    axisValues = function (s) return copyTable(s:getAxisValues()) end,
    textureNames = function (s) return copyTable(s:getTextureNames()) end,
