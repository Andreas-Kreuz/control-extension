...
- Unabhängig davon, ob EEP-Signale genutzt werden, können verschiedene Immobilien für rot, gelb, grün und Anforderung beleuchtet werden. Dann sind mehrere `lightStructures` gesetzt. Man kann dabei mehrere gleichzeitig mit einem Index angeben: `lightStructures.<n>.structureRed`, `lightStructures.<n>.structureYellow`, `lightStructures.<n>.structureGreen`, `lightStructures.<n>.structureRequest`, `lightStructures.<n>.structureHousing`, `lightStructures.<n>.structureBlend`.
...
| `lightStructures.<n>.structureHousing` | `string` oder nicht gesetzt; Beispiel: `#5522_Straba Signal Gehäuse Mast 4`                                                | Optionales Gehäuse für Ampelaufsteller-Tags und Ausrichtung.                                                                                                                                                              |
| `lightStructures.<n>.structureBlend`   | `string` oder nicht gesetzt; Beispiel: `#5527_Straba Signal Gehäuse Blendschutz 4`                                         | Optionaler Blendschutz für Ampelaufsteller-Tags und Ausrichtung.                                                                                                                                                          |
