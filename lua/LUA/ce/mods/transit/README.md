...
Für paketweite Anzeigeeinstellungen gibt es das Objekt `TransitSettings`.

- `TransitSettings.loadSettingsFromSlot(eepSaveId)` lädt die Einstellungen aus einem EEP-Speicherslot.
- `TransitSettings.setShowDepartureTippText(boolean)` schaltet Tipp-Texte für Abfahrtsanzeigen ein oder aus.
