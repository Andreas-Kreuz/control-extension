...
local BusHSdfi_RG3 = require("ce.mods.transit.models.V15NRG35002_BusHSdfi_RG3")
local BusHS_Tram_Info_6_RG3 = require("ce.mods.transit.models.V15NRG35023_BusHS_Tram_Info_6_RG3")
local BusHS_Tram_dfi_6_RG3 = require("ce.mods.transit.models.V15NRG35023_BusHS_Tram_dfi_6_RG3")
...
--------------------------------------------------------------------------------------------------------------------
DisplayModel.SimpleStructure = DisplayModel:new(SimpleStructure.name,
                                                SimpleStructure.initStation,
                                                SimpleStructure.displayEntries)

--------------------------------------------------------------------------------------------------------------------
-- V15NDL10027 - Texturierbare Zielanzeigen für Haltestellen
--------------------------------------------------------------------------------------------------------------------
DisplayModel.Tram_Schild_DL1 = DisplayModel:new(Tram_Schild_DL1.name,
                                                Tram_Schild_DL1.initStation,
                                                Tram_Schild_DL1.displayEntries)

--------------------------------------------------------------------------------------------------------------------
-- V15NRG35002 - Buswartehaeuser in Dioramaqualitaet mit DFI
--------------------------------------------------------------------------------------------------------------------
DisplayModel.BusHSInfo_RG3 = DisplayModel:new(BusHSInfo_RG3.name,
                                              BusHSInfo_RG3.initStation,
                                              BusHSInfo_RG3.displayEntries)
DisplayModel.BusHSdfi_RG3 = DisplayModel:new(BusHSdfi_RG3.name,
                                             BusHSdfi_RG3.initStation,
                                             BusHSdfi_RG3.displayEntries)

--------------------------------------------------------------------------------------------------------------------
-- V15NRG35023 - DFI digitale Fahrgastinformation für 6 Linien
--------------------------------------------------------------------------------------------------------------------
DisplayModel.BusHS_Tram_Info_6_RG3 = DisplayModel:new(BusHS_Tram_Info_6_RG3.name,
                                                      BusHS_Tram_Info_6_RG3.initStation,
                                                      BusHS_Tram_Info_6_RG3.displayEntries)
DisplayModel.BusHS_Tram_dfi_6_RG3 = DisplayModel:new(BusHS_Tram_dfi_6_RG3.name,
                                                     BusHS_Tram_dfi_6_RG3.initStation,
