insulate("Crossing", function ()
    ...
    describe("Lane sequence NONE -> A", function ()
        ...
        it("Green K1 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K1]) end)
        it("Green K2 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K2]) end)
        it("Green K3 ", function () assert.equals(IntersectionSequence.Type.PEDESTRIAN, g[K3]) end)
        it("Green K5 ", function () assert.is_falsy(g[K5]) end)
        it("Green K6 ", function () assert.equals(IntersectionSequence.Type.PEDESTRIAN, g[K6]) end)
        it("Green K7 ", function () assert.is_falsy(g[K7]) end)
        it("Green K8 ", function () assert.is_falsy(g[K8]) end)
        it("Green K9 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K9]) end)
    end)
    ...
    describe("Lane sequence NONE -> B", function ()
        ...
        it("Green K7 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K7]) end)
        it("Green K8 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K8]) end)
        it("Green K9 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K9]) end)
    end)
    ...
    describe("Lane sequence NONE -> C", function ()
        ...
        it("Green K1 ", function () assert.equals(IntersectionSequence.Type.PEDESTRIAN, g[K1]) end)
        it("Green K2 ", function () assert.equals(IntersectionSequence.Type.PEDESTRIAN, g[K2]) end)
        it("Green K3 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K3]) end)
        it("Green K5 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K5]) end)
        it("Green K6 ", function () assert.equals(IntersectionSequence.Type.CAR, g[K6]) end)
        it("Green K7 ", function () assert.is_falsy(g[K7]) end)
        it("Green K8 ", function () assert.equals(IntersectionSequence.Type.PEDESTRIAN, g[K8]) end)
        it("Green K9 ", function () assert.equals(IntersectionSequence.Type.PEDESTRIAN, g[K9]) end)
    end)

    describe("Lane sequence A -> B", function ()
        local r, g = sequenceB:trafficLightsToTurnRedAndGreen(sequenceA)

        it("Red K1 ", function () assert.equals(IntersectionSequence.Type.CAR, r[K1]) end)
        it("Red K2 ", function () assert.equals(IntersectionSequence.Type.CAR, r[K2]) end)
        it("Red K3 ", function () assert.equals(IntersectionSequence.Type.PEDESTRIAN, r[K3]) end)
        it("Red K5 ", function () assert.is_falsy(r[K5]) end)
        it("Red K6 ", function () assert.equals(IntersectionSequence.Type.PEDESTRIAN, r[K6]) end)
        it("Red K7 ", function () assert.is_falsy(r[K7]) end)
        it("Red K8 ", function () assert.is_falsy(r[K8]) end)
        it("Red K9 ", function () assert.is_falsy(r[K9]) end)
