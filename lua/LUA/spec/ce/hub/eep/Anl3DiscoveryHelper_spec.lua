insulate("ce.hub.eep.Anl3DiscoveryHelper", function ()
    ...
    it("extracts static topology and coverage from anl3", function ()
        local dt = buildDiscoveryTable(table.concat({
            ...
            "</Gleissystem>",
            '<Gleissystem GleissystemID="2" TrackSystemNumber="2"><Gleis GleisID="22"/></Gleissystem>',
            ...
            "</Gleis>",
            "</Gleissystem>",
            '<Gleissystem GleissystemID="4" TrackSystemNumber="4"><Gleis GleisID="55"/></Gleissystem>',
            '<Gleissystem GleissystemID="5" type="Steuerstrecken"><Gleis GleisID="66"/></Gleissystem>',
            '<Fuhrpark FuhrparkID="1">',
            '<Zugverband name="#Train A" Route="7" Geschwindigkeit="12" sollgeschwindigkeit="20"',
            ' kupplungvorn="1" kupplunghinten="2">',
            '<Gleisort gleissystemID="3" gleisID="33" parameter="456.7" ausrichtung="1"/>',
            '<Rollmaterial name="RS A" typ="STRASSE\\BUS\\A.3dm"/>',
            "</Zugverband>",
            "</Fuhrpark>",
            '<Gebaeudesammlung><Immobile name="#12" gsbname="Haus.3dm"/></Gebaeudesammlung>',
