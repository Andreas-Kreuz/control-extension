insulate("CeHubModule", function ()
    ...
    it("records timings for initial discovery and recurring updates", function ()
        ...
        assert.equals(2, RuntimeMetrics.get("Update/ce.hub.Module").count)
        assert.equals(2, RuntimeMetrics.get("Discovery/ce.hub.Signal").count)
        assert.equals(2, RuntimeMetrics.get("Update/ce.hub.Structure").count)
        assert.equals(2, RuntimeMetrics.get("Update/ce.hub.Time").count)
        assert.equals(2, RuntimeMetrics.get("Update/ce.hub.RollingStock").count)
        assert.equals(2, RuntimeMetrics.get("Discovery/ce.hub.Train").count)
