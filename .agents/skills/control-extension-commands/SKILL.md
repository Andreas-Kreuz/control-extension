...
- Cypress/app E2E root scripts: `cmd /c yarn.cmd test:app`, `cmd /c yarn.cmd test:app:ui`, `cmd /c yarn.cmd test:web`, `cmd /c yarn.cmd test`, `cmd /c yarn.cmd build:docs:assets`, `cmd /c yarn.cmd build:docs:assets:force`
