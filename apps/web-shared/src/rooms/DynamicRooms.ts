...
const StructureStaticRoom = new DynamicRoom(CeTypes.HubStructureStatic);
const StructureDynamicRoom = new DynamicRoom(CeTypes.HubStructureDynamic);
...
export { StructureStaticRoom };
export { StructureDynamicRoom };
