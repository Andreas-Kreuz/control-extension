...
export const CeTypes = {
  ...
  HubRollingStockStatic: 'ce.hub.RollingStockStatic',
  HubRollingStockDynamic: 'ce.hub.RollingStockDynamic',
  HubRollingStockTextures: 'ce.hub.RollingStockTextures',
  HubRollingStockRotation: 'ce.hub.RollingStockRotation',
