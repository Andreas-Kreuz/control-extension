export class RoadEvent {
  // System room for road control and road-status coordination.
  ...
  static readonly FocusStructureSignalInstallerCamera = '[Road Event] Focus Structure Signal Installer Camera';
}
