...
import { LegacyTransitLineCard as MyLegacyTransitLineCard } from './LegacyTransitLineCard.component';
import Line from '../../../features/lines/model/Line';
import StationInfo from '../../../features/lines/model/StationInfo';

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta = {
  title: 'Module Elements/Transit/LegacyTransitLineCard',
  tags: ['autodocs'],
  component: MyLegacyTransitLineCard,
} satisfies Meta<typeof MyLegacyTransitLineCard>;
